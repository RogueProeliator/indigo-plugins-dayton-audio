...
#/////////////////////////////////////////////////////////////////////////////////////////
#/////////////////////////////////////////////////////////////////////////////////////////
# RPFrameworkUpdater by RogueProeliator <adam.d.ashe@gmail.com>
# 	Class to manage plugin updates from GitHub... based upon the fine work of jheddings,
...
class GitHubPluginUpdater(object):
	...
	#---------------------------------------------------------------------------
	def __init__(self, plugin=None, configFile='UpdaterConfig.cfg'):
		self.plugin = plugin
	...
	def getUpdate(self, currentVersion):
		...
		self.latestReleaseFound = latestVersion
